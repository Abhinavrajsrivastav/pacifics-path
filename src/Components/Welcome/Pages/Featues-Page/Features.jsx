  ...
  return (
    <div className="features-page">
      ...
      <div className="features-body">
        ...
        <FeaturesCard className="features-card" icons={"./Icons/representative.png"} heading={"Find Right Mate"} subheading={"A platform to connect with the perfect teammate."}/>
